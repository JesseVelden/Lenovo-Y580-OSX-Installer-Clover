...
//XFMod
NSString *SRStringForKeyEquivalentAndCocoaFlags(NSString* keyEquivalent, NSUInteger cocoaFlags);

KeyCombo SRKeyComboForKeyEquivalentAndCocoaFlags(NSString* keyEquivalent, NSUInteger flags);
